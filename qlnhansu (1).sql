...
CREATE TABLE `tlb_chucvu` (
  `ma_chucvu` varchar(10) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `tlb_congviec` (
  `ma_congviec` varchar(10) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `tlb_hopdong` (
  `ma_hopdong` varchar(10) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `tlb_luong` (
  `ma_luong` varchar(10) COLLATE utf8_bin NOT NULL,
